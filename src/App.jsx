  ...
  return (
    <>
      ...
      <div className='flex justify-end p-6'>
        <button className='bg-gray-200 p-4 rounded-full text-gray-700 text-xl hover:bg-gray-300 cursor-pointer'><FaMoon /></button>
      </div>
      ...
      <div className='px-8 py-12 space-y-5'>
        ...
        <p className='text-md md:text-lg text-left text-slate-700'>Switch effortlessly between light and dark themes with a single click.
      ...
      <div className='px-8 py-12 space-y-5 bg-gray-100'>
        <h1 className='text-2xl md:text-3xl bg-gradient-to-l from-violet-700 to-pink-700 text-transparent bg-clip-text font-semibold'>About This Project</h1>
        <p className='text-md md:text-lg text-left text-slate-700'>This Dark & Light Mode Theme Switcher is a React-based UI experiment
